        ...
        <form action="/books/{{$book->id}}" method="POST"  enctype="multipart/form-data">
            ...
            <div class="shadow sm:overflow-hidden sm:rounded-md">
                <div class="space-y-6 px-4 py-5 sm:p-6">
                    <div class="grid grid-cols-3 gap-6">
                        <div class="col-span-3 sm:col-span-2">
                            ...
                            <input type="text" name="id" value="{{ $book->id }}" id="" autocomplete="address-level2"
                    ...
                    <div class="col-span-2 sm:col-span-2">
                        ...
                        <input type="date" name="date" value="{{ $book->date }}" id="" autocomplete="address-level2"
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <textarea id="" name="desc" rows="3"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">{{ $book->desc }}
                            </textarea>
                        </div>
                    </div>
                            ...
                            <div class="space-y-1 text-center">
                                ...
                                <div class="flex text-sm text-gray-600">
                                    <label for="file-upload"
                                        ...
                                        <input id="file-upload" name="img" value="{{ $book->img }}" type="file" accept="image/*"
                                            class="sr-only" >
                                    </label>
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <input type="text" name="age" value="{{ $book->age }}" id=""
                                class="block w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                        </div>
                    </div>

                    <div>
                        <label for="" class="block text-sm font-medium text-gray-700">Categoria</label>
                        <div class="mt-1">
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <input type="text" name="pag" value="{{ $book->pag }}" id=""
                                class="block w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <select id="status" name="status" value="{{ $book->status }}" autocomplete="status-name"
                ...
                <div class="bg-gray-50 px-4 py-3 text-right sm:px-6">
                    <button type="submit"
                        class="inline-flex justify-center rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Actualizar</button>
                </div>
            </div>
        </form>
    </div>
